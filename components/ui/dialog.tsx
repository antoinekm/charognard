...
function DialogBackdrop({
  ...
  return (
    <DialogPrimitive.Backdrop
      className={cn(
        "fixed inset-0 z-10000 bg-black/32 backdrop-blur-sm transition-all duration-200 data-ending-style:opacity-0 data-starting-style:opacity-0",
        className,
      )}
...
function DialogViewport({
  ...
  return (
    <DialogPrimitive.Viewport
      className={cn(
        "fixed inset-0 z-10000 grid grid-rows-[1fr_auto_3fr] justify-items-center p-4",
        className,
      )}
